...
const activities: Activity[] = [
  { id: '1', type: 'complete', message: 'Training completato', project: 'Fraud Detection', user: 'Marco R.', time: '5 min fa' },
  { id: '2', type: 'commit', message: 'Versione 3.2 creata', project: 'Customer Churn', user: 'Giulia B.', time: '12 min fa' },
  { id: '3', type: 'upload', message: 'Dataset caricato (2.4GB)', project: 'Sentiment Analysis', user: 'Luca V.', time: '1 ora fa' },
  { id: '4', type: 'start', message: 'Pipeline avviata', project: 'Image Classification', user: 'Anna N.', time: '2 ore fa' },
  { id: '5', type: 'error', message: 'Errore validazione dati', project: 'Time Series', user: 'Marco R.', time: '3 ore fa' },
];
